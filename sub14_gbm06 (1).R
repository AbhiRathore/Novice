...
# get training data
training <- read.csv("data/training.csv", colClasses = c("integer",rep("numeric",31), "character"))
...
#make prediction
test<- read.csv("data/test.csv", colClasses = c("integer",rep("numeric",30)))
...
write.csv(submission, "data/sub14.csv", row.names=FALSE)
